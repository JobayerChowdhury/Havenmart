...
const showProducts = (products) => {
  ...
  for (const product of allProducts) {
    // showing stars according to rating
    let star = '';
    if (product.rating.rate >= 4 && product.rating.rate <= 4.9) {
    ...
    else if (product.rating.rate >= 3 && product.rating.rate <= 3.9) {
      star = `<i class="fas fa-star"></i>
      <i class="fas fa-star"></i>
      <i class="fas fa-star"></i>
      <i class="fas fa-star-half-alt"></i>
    ...
    else if (product.rating.rate >= 2 && product.rating.rate <= 2.9) {
      star = `<i class="fas fa-star"></i>
      <i class="fas fa-star"></i>
      <i class="fas fa-star-half-alt"></i>
      <i class="far fa-star"></i>
    ...
    else if (product.rating.rate >= 1 && product.rating.rate <= 1.9) {
      star = `<i class="fas fa-star"></i>
      <i class="fas fa-star-half-alt"></i>
      <i class="far fa-star"></i>
      <i class="far fa-star"></i>
    ...
    <img class="product-image" src=${product.image}></img>
      ...
      <p> <strong> Rating: </strong><strong> ${product.rating.rate},  Reviews: ${product.rating.count} </strong> </p>
      <div> ${star}</div>
    </div>
      <button onclick="addToCart(${product.id},${product.price})" id="addToCart-btn" class="Add-cart btn btn-dark">add to cart</button>
